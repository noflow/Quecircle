...
function CirclePage({ onInvite, onOpen }: { onInvite: () => void; onOpen: (title?: string, meta?: string, score?: string) => void }) { return <><PeopleFinder/><CirclePageBase onInvite={onInvite}/><ChatWall onOpen={onOpen}/><MovieNightPanel/></>; }
